...
for line in lines:
    ...
    if in_settings and not config_added and line.strip() == 'model_config = {"extra": "ignore"}':
        config_added = True
    elif in_settings and not config_added and line.strip().startswith('environment'):
